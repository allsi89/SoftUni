function solve() {
    ...
    function addNewTruck() {
        ...
        let tires = document.getElementById('newTruckTiresCondition')
            .value.split(' ')
            .map(Number);
    ...
    function addNewTireSet() {
        ...
        let parentTruck = fieldSets[3].lastChild;
        ...
        if (obj.hasOwnProperty(plateNumber)) {
            ...
            if (results.finalResult) {
                ...
                if (results.finalResult) {
                    ...
                    usedTires.remove();  // removes the element (tireSet) from the html
                }
            }
        }
    }
